...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cmdstanpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12498&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cmdstanpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cmdstanpy` can be installed with:

```
conda install cmdstanpy
```

It is possible to list all of the versions of `cmdstanpy` available on your platform with:
